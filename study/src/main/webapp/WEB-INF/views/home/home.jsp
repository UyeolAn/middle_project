								...
								<div class="row">
									<div class="col-lg-7">
										<div class="hero__text">
											...
											<p style="font-family: 'NanumSquareRound'; color: black;">다양한 강의들을 할인된 가격으로
												만나보세요!</p>
									...
									<div class="col-lg-7">
										<div class="hero__text">
											...
											<h2 style="font-family: 'NanumSquareRound'; color: white;">IT 강의들
												잔뜩&#128218;</h2>
											<p style="font-family: 'NanumSquareRound'; color: white;">예비 개발자들을 위한 강의들을
												골라 들어보세요</p>
								...
								<div class="row">
									<div class="col-lg-7">
										<div class="hero__text">
											...
											<p style="font-family: 'NanumSquareRound'; color: black;">다양한 사람들과 소통을 하며
												궁금증을 해소!</p>
										</div>
									</div>
									<div class="col-lg-5" style="padding: 30px;">
						...
						<div class="row">
							<div class="col-lg-12" style="margin: 30px;">
								<ul class="filter__controls">
									<li class="active" data-filter=".mix" style="width: 150px;"><img src="client/img/home/all.png"
											style="width: 30px;" title="All"> ALL</li>
									<li data-filter=".hot" style="width: 150px;"><img src="client/img/home/heart.png" style="width: 30px;"
											title="Best Hot"> HOT</li>
									<li data-filter=".review" style="width: 150px;"><img src="client/img/home/star.png"
											style="width: 30px;" title="Best Review"> REVIEW</li>
									<li data-filter=".it" style="width: 150px;"><img src="client/img/home/computer.png"
											style="width: 30px;" title="Best IT"> IT</li>
						...
						<div class="row" style="justify-content: space-between;">
							<div class="col-lg-3 col-md-6 col-sm-6" style="max-width: 60%; flex: none;">
								<div class="footer__about" style="margin-bottom: 0;">
									<h6 class="font-weight-bold" style="color: white; font-size: 22px;">Today Course (주)TOCO</h6>
									<div>
										<p style="margin-bottom: 0; margin-top: 50px;">팀장: 송민주 / 팀원: 안우열, 양진우, 전유진</p>
										<p style="margin-bottom: 0;">대구광역시 중구 중앙대로 403 (남일동 135-1, 5층)</p>
										<p style="margin-bottom: 0;">사업자번호:123-45-67890 / Tel:053-111-2345 / Fax:053-123-5678</p>
									</div>
								</div>
							</div>
