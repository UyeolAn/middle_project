...
<body>
			...
			<div class="row">
				<div class="col-lg-3 col-md-3">
					<div class="header__logo">
						<a href="home.do"><img src="client/img/product/student.png"
				...
				<div class="col-lg-6 col-md-6">
					<nav class="header__menu mobile-menu">
						<ul>
							...
							<li><a href="packagelist.do">&#127873;Package</a> <!-- <ul class="dropdown">
					...
					<nav class="header__menu mobile-menu">
						<ul>
							<c:if test="${not empty loginId}">
								<li><a href="mypageprofile.do"><span>${loginName}
											님 접속중</span></a>
									<ul class="dropdown">
							...
							<c:if test="${empty loginId}">
								<li><a href="login.do" style="color: black;">Sign in</a></li>
							</c:if>
						</ul>
					</nav>
				</div>
	...
	<div class="hero__slider owl-carousel" style="height: 300px;">
		<div class="hero__items set-bg"
			style="padding: 30px; height: 300px; background-color: pink;">
					...
					<div class="row">
						<div class="col-lg-7">
							<div class="hero__text">
								<h6>SALE PACKAGE</h6>
								<h2 style="font-family: 'NanumSquareRound';">현재 할인하는
									패키지&#128176;</h2>
								<p style="font-family: 'NanumSquareRound'; color: black;">다양한
									강의들을 할인된 가격으로 만나보세요!</p>
					...
					<div class="row">
						<div class="col-lg-7">
							<div class="hero__text">
								...
								<h6>IT COURSES</h6>
								<h2 style="font-family: 'NanumSquareRound'; color: white;">IT
									강의들 잔뜩&#128218;</h2>
								<p style="font-family: 'NanumSquareRound'; color: white;">예비
									개발자들을 위한 강의들을 골라 들어보세요</p>
					...
					<div class="row">
						<div class="col-lg-7">
							<div class="hero__text">
								...
								<h2 style="font-family: 'NanumSquareRound';">질문이 있다면 바로
									&#128587;</h2>
								<p style="font-family: 'NanumSquareRound'; color: black;">다양한
									사람들과 소통을 하며 궁금증을 해소!</p>
							</div>
						</div>
						<div class="col-lg-5" style="padding: 30px;">
		...
		<div class="container">
				...
				<div class="col-lg-12" style="margin: 30px;">
					<ul class="filter__controls">
						<li class="active" data-filter=".mix" style="width: 150px;"><img
							src="client/img/home/all.png" style="width: 30px;" title="All">
							ALL</li>
						<li data-filter=".hot" style="width: 150px;"><img
							src="client/img/home/heart.png" style="width: 30px;"
							title="Best Hot"> HOT</li>
						<li data-filter=".review" style="width: 150px;"><img
							src="client/img/home/star.png" style="width: 30px;"
							title="Best Review"> REVIEW</li>
						<li data-filter=".it" style="width: 150px;"><img
							src="client/img/home/computer.png" style="width: 30px;"
							title="Best IT"> IT</li>
			...
			<div class="row product__filter">
				<c:forEach items="${reviewList}" var="r">
					<div
						class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix review course-col">
						<a href="coursedetail.do?courseId=${r.courseId}">
							<div class="product__item course-item">
								...
								<div class="product__item__text">
									<h6>${r.courseName}</h6>
									<div
										class="d-flex justify-content-space-between small text-warning mb-2"
										class="stars">
									...
									<c:choose>
										...
										<c:otherwise>
											<h5>
												<fmt:formatNumber value="${r.coursePrice }" pattern="#,###" />
												원
											</h5>
										</c:otherwise>
									</c:choose>
				...
				<c:forEach items="${hotList}" var="h">
					<div
						class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot course-col">
							...
							<div class="product__item course-item">
								...
								<div class="product__item__text">
									...
									<c:choose>
										...
										<c:otherwise>
											<h5>
												<fmt:formatNumber value="${h.coursePrice }" pattern="#,###" />
												원
											</h5>
										</c:otherwise>
									</c:choose>
				...
				<c:forEach items="${itList}" var="l">
					<div
						class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix it course-col">
							...
							<div class="product__item course-item">
								...
								<div class="product__item__text">
									...
									<c:choose>
										...
										<c:otherwise>
											<h5>
												<fmt:formatNumber value="${l.coursePrice }" pattern="#,###" />
												원
											</h5>
										</c:otherwise>
									</c:choose>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="footer__about">
						<div class="footer__logo">
							<a href="#"><img src="client/img/product/student.png"
								style="width: 100px;" alt=""></a>
						</div>
						<h6 class="font-weight-bold" style="color: white;">&#129293;방문해주셔서
							감사합니다!!&#129293;</h6>
					</div>
