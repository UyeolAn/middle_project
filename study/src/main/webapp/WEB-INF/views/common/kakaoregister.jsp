                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user btmagin4"
                                                    ...
                                                    value="<c:if test='${sessionScope.kakaoEmail != null}'>${sessionScope.kakaoEmail}</c:if>"
                                                    readonly>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-control-user"
                                                    id="memberName" name="memberName" placeholder="Name" maxlength="10"
                                                    value="<c:if test='${sessionScope.kakaoNickname != null}'>${sessionScope.kakaoNickname}</c:if>"
                                                    readonly>
                                            </div>
                                        </div>
