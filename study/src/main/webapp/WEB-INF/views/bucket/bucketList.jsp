	...
	<section class="shopping-cart">
					...
					<tbody>
						<c:forEach items="${courses}" var="c">
							<tr>
								...
								<td class="cart__close"><i class="fa fa-close" onclick="bucketDelete('${member.memberId}', ${c.courseId }, this)"></i></td>
							</tr>
						</c:forEach>
						...
						<c:if test="${message eq 'empty'}"></c:if>
					</tbody>
				</table>
			</div>
		</div>
		<div class="col-lg-8">
			...
			<div class="cart__total">
				...
				<ul>
					<li>총 결제금액 <span class="cart_sum_price"><fmt:formatNumber value="${sum }" pattern="#,###" />원</span></li>
				</ul>
