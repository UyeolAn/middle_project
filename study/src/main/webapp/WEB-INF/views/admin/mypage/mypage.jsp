        ...
        <div class="card-body">
            <form id="frm2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="sample6_address" class="form-control mb-2" style="width: 100%; display: inline;" value="${m.memberAddress}" placeholder="주소" required>
                    <div class="row mb-2" style="width: 100%; margin-left: 0;">
                        <input type="text" id="sample6_detailAddress" class="form-control col-lg-6" style="width: 50%; display: inline;" placeholder="상세주소"><!--
                        --><input type="text" id="sample6_extraAddress" class="form-control col-lg-6" style="width: 50%; display: inline;" placeholder="참고항목">
                    </div>
                </div>
                <div class="form-group">
                    <label class="font-weight-bold" style="display: block;" >이메일</label>
